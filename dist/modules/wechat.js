 ...
 */
const WECHAT_USER_AGENT = 'Mozilla/5.0 (Linux; Android 13; Pixel 7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.6099.230 Mobile Safari/537.36';
// ─── Main function ────────────────────────────────────────────
export async function processWechatArticle(url) {
    try {
        ...
        const result = await createTelegraphPage({
            title,
 ...
 */
function buildTelegraphHtml(title, contentHtml) {
