...
function picUrlFromPid(pid: string): string {
...
export async function downloadWeibo(
  url: string,
  ...
  try {
    ...
    const pics = post.pics as Array<{ pid?: string; large?: { url?: string }; url?: string }> | undefined;
